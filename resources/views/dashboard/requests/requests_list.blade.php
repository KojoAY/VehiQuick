                            ...
                            <section class="offer-list-display">
                                <section class="list-ride-info">
                                    <article>
                                        ...
                                        <div id="request-dep-date">
                                            <div id="refs"><strong>6</strong> referals</div>
                                            <strong>Thu, May 30</strong>
                                        </div>
                                    </article>
                                    
                                    <article class="dashboard-list-user-info">
                                        <a id="set-request-btn">Edit</a> 
                                        <section class="set-lift-alert-popup">
                                            <form action="" method="post">
                                                <a class="fa fa-close" style="top: -40px; right:-30px;"></a>
                                                <div>
                                        ...
                                        <a id="del-offer">Cancel</a>
                                        <section class="del-offer-popup">
                                            <form action="" method="post">
                                        ...
                                        <a href="../../dashboard/user-code/requests/referals" id="expand" class="fa fa-angle-double-right"></a>
                                    </article>
                                </section>
                            </section>
                            ...
                            <section class="offer-list-display">
                                <section class="list-ride-info">
                                    <article>
                                        ...
                                        <div id="request-dep-date">
                                            <div id="refs"><strong>23</strong> referals</div>
                                            <strong>Thu, May 30</strong>
                                        </div>
                                    </article>
