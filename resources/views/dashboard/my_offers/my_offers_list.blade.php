        ...
        <section class="main-content-box">
            ...
            <article class="lift-details-box" id="user-profile-box">
                ...
                <ul class="user-info-ul">
                	...
                	<li class="user-info">
                    	<h3 id="page-label">
                            <strong>3 lift offers</strong> - [ page 1 of 1 pages ]
                        </h3>
                        	...
                        	<section class="offer-list-display">
                                ...
                                <section class="list-ride-info">
                                    ...
                                    <article class="dashboard-list-user-info">
                                        <a href="../../dashboard/user-code/offers/edit">Edit</a> <a id="del-offer">Delete</a>
                                        ...
                                        <a href="../../dashboard/user-code/offers/details" id="expand" class="fa fa-angle-double-right"></a>
                                    </article>
                                </section>
                            </section>
