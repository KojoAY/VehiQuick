                	...
                	<li class="user-info">
                    	<form action="" method="post" class="dashboard-form">
                            <section class="user-info-divs">
                                <article id="pickup-loc"><div id="label">First Name</div> <input type="text" name=""></article>
                                <article id="pickup-loc"><div id="label">Last Name</div> <input type="text" name=""></article>
                                <article id="pickup-loc"><div id="label">Gender</div> <label><input type="radio" checked name="" value="1"> Male</label> <label><input type="radio" name="" value="2"> Female</label></article>
                                <article id="pickup-loc"><div id="label">Year of Birth</div> 
                                	<select name="">
										<?php
                                        $END_DATE = date('Y') - 18;
                            ...
                            <section class="user-info-divs">
                                <article id="pickup-loc"><div id="label">Email</div> <input type="text" name=""></article>
                                <article id="pickup-loc"><div id="label">Password</div> <input type="password" name=""></article>
                                <article id="pickup-loc"><div id="label">Phone No.</div> <input type="text" name=""></article>
                            </section>
                            
                            <section class="user-info-divs">
                                <article id="pickup-loc"><div id="label">Country</div> <input type="text" name=""></article>
                                <article id="pickup-loc"><div id="label">Region</div> <input type="text" name=""></article>
                                <article id="pickup-loc"><div id="label">Town</div> <input type="text" name=""></article>
                            </section>
                            
                            <section class="user-info-divs">
                                <article id="pickup-loc"><div id="label">Languages</div> <input type="text" name=""></article>
                                <article id="pickup-loc"><div id="label">About Me</div> <textarea name=""></textarea></article>
                            </section>
