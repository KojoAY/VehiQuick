                ...
                <ul class="user-info-ul">
                	...
                	<li class="user-info">
                    	<form action="" method="post" class="messages-form">
                            <section class="chathead-list">
                                <a><div id="msg-head"></div> Messeger 1</a>
                                <a><div id="msg-head"></div> Messeger 2</a>
                                <a><div id="msg-head"></div> Messeger 3</a>
                                <a><div id="msg-head"></div> Messeger 4</a>
                                <a><div id="msg-head"></div> Messeger 5</a>
                                <a><div id="msg-head"></div> Messeger 6</a>
                                <a><div id="msg-head"></div> Messeger 7</a>
                                <a><div id="msg-head"></div> Messeger 8</a>
                            </section>
                            ...
                            <section class="chat-window">
                                ...
                                <article id="msg-to">
                                	...
                                	hello I have seen it
                                    <em>02:38PM</em>
                                </article>
                                
                            </section>
                            
                            <textarea name="" placeholder="Type message here..."></textarea>
