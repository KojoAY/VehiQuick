                ...
                <ul class="user-info-ul">
                	...
                	<li class="user-info">
                    	...
                    	<article class="lift-details-box">
                            ...
                            <section class="trip-det" style="text-align: center;">
                            	<h2>You've booked <strong>1</strong> seat</h2>
                            </section>
                            ...
                            <section class="trip-det">
                                ...
                                <article id="seats-left"><div id="label">Seats</div> 2 of 3 seats left</article>
                            </section>
